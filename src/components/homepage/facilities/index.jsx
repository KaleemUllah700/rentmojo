...
const facilities = [
    ...
    return (
        <div>
            <div className="bg-[white] h-[70px] mx-16 flex flex-col justify-center my-2 text-xl">
                <h1 className="font-bold opacity-70">There's more</h1>
                <h1>to renting</h1>
                <hr className="my-2 w-[60px] text-black text-xl font-bold"  />
            </div>
            <div className="bg-[white] h-[230px] mx-16 my-2 flex py-4">
                {
                    facilities.map((facility, index)=>(
                            <div className="w-[370px] h-[200px] bg-[white] flex flex-col mx-2" key={index}>
